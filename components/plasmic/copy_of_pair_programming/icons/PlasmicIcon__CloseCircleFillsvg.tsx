...
export type CloseCircleFillsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CloseCircleFillsvgIcon(props: CloseCircleFillsvgIconProps) {
...
export default CloseCircleFillsvgIcon;
/* prettier-ignore-end */
